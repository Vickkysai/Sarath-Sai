...
class travel:
    ...
    def __init__(self, root):
        self.root = root
        self.root.title("Taxi Booking System In KCIC")
        ...
        def Kilo():
            list_of_pick_up_location_and_drop_locations = ['AdmissionBlock', 'BoysHostel', 'GirlsHostel', 'CampusCafe']
            if var2.get() == 0:
                self.txtKm.configure(state=DISABLED)
                Km.set("0")
                ...
                if varl1.get() == "CampusCafe":
                    switch = {"BoysHostel": 10, "GirlsHostel": 8, "AdminBlock": 6, "CampusCafe": 0}
        ...
        self.lblTitle = Label(Tops, font=('arial', 70, 'bold'), text=" Taxi Booking System in KCIC ")
        self.lblTitle.grid()
